...
<nav id="main-header">
    <div class="nav-wrapper">
        <ul class="left">
            <li>
                <a href="https://istrav.com" class="btn"
        ...
        <ul class="right">
            ...
            <li><a href="/machines/decoy#main-header">Decoy Machines</a></li>
        </ul>
    </div>
</nav>
