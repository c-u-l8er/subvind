        ...
        <div class="control-panel">
            <div class="content">
                <div class="main-settings">
                    ...
                    >
                    <a href="#!" class="btn btn-large" on:click={(e) => stop(e)}
                        ><i class="material-icons">stop</i></a
                    >
                    <a
                        href="#!"
                        class="btn btn-large dropdown-trigger"
                    ...
                    >
                        <li>
                            <a href="#!" on:click={(e) => change(e, 0)}
                                >RGBY (Mix Bounce)</a
                            >
                        </li>
                        <li>
                            <a href="#!" on:click={(e) => change(e, 1)}
                                >Red or Blue (Fair Bounce)</a
                            >
                        </li>
                        <li>
                            <a href="#!" on:click={(e) => change(e, 2)}
                                >Red and Blue (Double Bounce)</a
                            >
                        </li>
                        <li class="divider" tabindex="-1"></li>
                        <li>
                            <a href="#!" on:click={(e) => change(e, 3)}
                                >Leaning (25:25:0:50)</a
                            >
                        </li>
                        <li>
                            <a href="#!" on:click={(e) => change(e, 4)}
                                >Center (0:50:50:0)</a
                            >
                        </li>
                        <li>
                            <a href="#!" on:click={(e) => change(e, 5)}
                                >Extreme (50:0:0:50)</a
                            >
                        </li>
                        <li class="divider" tabindex="-1"></li>
                        <li>
                            <a href="#!" on:click={(e) => change(e, 6)}
                                >Inside Wins (10:40:40:10)</a
                            >
                        </li>
                        <li>
                            <a href="#!" on:click={(e) => change(e, 7)}
                                >Outside Wins (40:10:10:40)</a
                            >
                        </li>
                    </ul>
                </div>
        ...
        <div style="border: 1px solid #fff; background: #000; margin: 0 3em;">
            <div class="amalgam">
                <Machine
                    bind:term
                    bind:machine
                    bind:environment={environments[environmentIndex]}
                    {initiate}
                />
            </div>
        </div>
            ...
            <div class="max-amalgam">
                ...
                <div style="text-align: center; height: 0.2em;">
                    <button
                        ...
                        ><i class="material-icons">all_inclusive</i></button
                    >
                </div>
            </div>
        </div>
...
<style>
    .motherboard {
        border-bottom: 0.5em dashed #000;
    ...
    .control-panel {
        ...
        background-image: url("data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 0h20v20H0V0zm10 17a7 7 0 1 0 0-14 7 7 0 0 0 0 14zm20 0a7 7 0 1 0 0-14 7 7 0 0 0 0 14zM10 37a7 7 0 1 0 0-14 7 7 0 0 0 0 14zm10-17h20v20H20V20zm10 17a7 7 0 1 0 0-14 7 7 0 0 0 0 14z' fill='%23666666' fill-opacity='0.4' fill-rule='evenodd'/%3E%3C/svg%3E");
    }
